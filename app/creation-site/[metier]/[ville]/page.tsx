    ...
    <main className="relative min-h-screen bg-[#F5F2EB] text-neutral-900">
      ...
      <section className="relative pt-44 pb-28 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          backgroundImage: `linear-gradient(rgba(17,13,11,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(17,13,11,0.03) 1px, transparent 1px)`,
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-base md:text-lg text-[#110D0B]/70 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#contact"
              className="px-8 py-3.5 rounded-full text-sm font-medium transition-all duration-300 bg-neutral-900 text-white hover:bg-neutral-800 shadow-lg shadow-neutral-900/5"
              data-cursor
            >
              Lancer mon projet
            </a>
            <a
              href="#indispensable"
              className="px-8 py-3.5 rounded-full text-sm font-medium transition-all duration-300 text-[#110D0B]/60 hover:text-[#110D0B]"
              data-cursor
            >
              En savoir plus ↓
            </a>
      ...
      <section id="indispensable" className="py-32 px-6 border-t" style={{ borderColor: "rgba(0,0,0,0.05)" }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          
          {/* Text block */}
          <div className="space-y-6">
            <h2 className="text-2xl md:text-4xl font-bold text-neutral-900 font-display">
            ...
            <p className="text-sm md:text-base text-[#110D0B]/70 leading-relaxed">
              À {villeLabel}, la majority de vos clients cherchent un artisan en ligne. Si vous n'avez pas de site web, ou si votre site ne donne pas une image professionnelle immédiate, vos clients se tourneront vers vos concurrents.
            </p>
            <p className="text-sm md:text-base text-[#110D0B]/70 leading-relaxed">
            ...
            <ul className="space-y-4 pt-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-neutral-800">SEO Local Avancé</h4>
                  <p className="text-xs text-[#110D0B]/55">Votre site est optimisé pour ressortir premier quand les clients de {villeLabel} recherchent un {metierLabel.toLowerCase()}.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#c9a96e] text-lg font-mono">02.</span>
                <div>
                  <h4 className="text-sm font-semibold text-neutral-800">Confiance & Professionnalisme</h4>
                  <p className="text-xs text-[#110D0B]/55">Présentation soignée de vos réalisations, de vos certifications (RGE, Décennale) et des avis de vos clients satisfaits.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#c9a96e] text-lg font-mono">03.</span>
                <div>
                  <h4 className="text-sm font-semibold text-neutral-800">Demandes de Devis Directes</h4>
                  <p className="text-xs text-[#110D0B]/55">Un parcours utilisateur fluide avec formulaires d'estimation de travaux et boutons d'appel rapides sur mobile.</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="relative group">
            ...
            >
              <img 
                ...
                className="w-full h-[320px] md:h-[420px] object-cover opacity-80 transition-transform duration-700 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent" />
              <div className="absolute bottom-6 left-6 right-6">
                <p className="text-xs text-[#c9a96e] font-mono tracking-widest uppercase mb-1">Concept Design</p>
                <h3 className="text-lg font-bold text-white font-display">Maquette de site vitrine {metierLabel.toLowerCase()}</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA section */}
      <section className="py-28 px-6 text-center border-t border-b" style={{ borderColor: "rgba(0,0,0,0.05)", background: "rgba(201,169,110,0.03)" }}>
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-xs md:text-sm text-[#110D0B]/70 max-w-xl mx-auto">
